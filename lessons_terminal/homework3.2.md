...
Прочитал в статье: [SSH inside SSH fails with "stdin: is not a tty"](https://unix.stackexchange.com/questions/48527/ssh-inside-ssh-fails-with-stdin-is-not-a-tty)
...
>13. Бывает, что есть необходимость переместить запущенный процесс из одной сессии в другую.\
	Попробуйте сделать это, воспользовавшись reptyr. [хелп по reptyr](https://github.com/nelhage/reptyr#readme)\
...
Как советуют на множестве форумов - попробуйте ключ `-T`.\
К сожалению, в этом случае виртуалка практически умирает - почти все ресурсы CPU утилизируются.\
...
Спасибо, было не понятно. Даже гугл не помог. В интернете тысячи вопросов на эту тему и __ни одного рабочего ответа__.
