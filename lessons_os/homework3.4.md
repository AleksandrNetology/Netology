...
root@vagrant:/#
```
Видим, что наш процесс `sleep` имеет PID=1 в этом NS.\
...
`ничего_не_делать(пусто){ничего_не_делать pipe ничего_не_делать в фоне} после_предыдущего ничего_не_делать`.
Бред какой-то. Скрипты я пока не знаю и разобраться с этим самостоятельно не могу. Гугл мне не помог.
