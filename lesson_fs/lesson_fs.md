...
- Blocks: 8 - количество блоков, которые занимает файл на диске. 1 блок = 512 байт;
- IO Block: 4096 - размер блока файловой системы в кб;
- Inode: 262844 - номер inode для этого файла, но об этом позже;
