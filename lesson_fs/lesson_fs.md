...
Это значит, в том числе и то, что удаление одного из них не осводит место в файловой системе т.к. второй продолжает существовать.
...
с помощью команды `ls`, происходит системный вызов __`getdents64`__.
